...
public class TimeEntry implements Serializable{
	...
	private int totalHoursPerShift;
	
	
	public int getTotalHoursPerShift() {
		return totalHoursPerShift;
	}

	public void setTotalHoursPerShift(int totalHoursPerShift) {
		this.totalHoursPerShift = totalHoursPerShift;
	}
