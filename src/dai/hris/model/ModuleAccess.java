...
public class ModuleAccess implements Serializable {
	...
	private List<String> systemTabList;
	...
	public List<String> getSystemTabList() {
		if ((systemTabList == null || systemTabList.isEmpty()) && systemTab != null) {
			String[] strArray = systemTab.split(",");
			systemTabList = new ArrayList<String>(Arrays.asList(strArray));
		}
		return systemTabList;
	}
	public void setSystemTabList(List<String> systemTabList) {
		this.systemTabList = systemTabList;
	}
	
	public String getSystemTab() {
		if (systemTab == null && systemTabList != null) {
			StringBuilder sb = new StringBuilder();
			for (String s : systemTabList) {
				sb.append(s);
				sb.append(",");
			}
			systemTab = sb.toString();
		}
		return systemTab;
	}
	public void setSystemTab(String systemTab) {
		this.systemTab = systemTab;
		if ((systemTabList == null || systemTabList.isEmpty()) && this.systemTab != null) {
			String[] strArray = this.systemTab.split(",");
			systemTabList = new ArrayList<String>(Arrays.asList(strArray));
		}
	}
