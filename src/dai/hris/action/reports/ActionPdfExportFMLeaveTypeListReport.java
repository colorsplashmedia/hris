 ...
 */
@WebServlet("/ActionPdfExportFMLeaveTypeListReport")
public class ActionPdfExportFMLeaveTypeListReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportFMLeaveTypeListReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/LeaveTypeReport.jasper");
		...
		try {
			...
			if(dataList.isEmpty()){
				...
				model.setLeaveTypeId(0);
				model.setLeaveTypeName("");
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/LeaveTypeReport.jasper");
				...
				String reportName = "leaveTypeListReport" + "_" + employeeLoggedIn.getSectionId() 
				...
				if(forExport.equals("Y")) {
					sysModel.setProcessDesc("EXPORT LEAVE TYPE REPORT");
					sysModel.setProcessType("EXPORT");
				} else {
					sysModel.setProcessDesc("VIEW PDF LEAVE TYPE REPORT");
					sysModel.setProcessType("VIEW PDF");
				}
				
				sysModel.setModuleName("LEAVE TYPE REPORT");
