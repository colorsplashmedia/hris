...
/**
 * Servlet implementation class ActionPdfExportObligationReport
 */
@WebServlet("/ActionPdfExportObligationReport")
public class ActionPdfExportObligationReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportObligationReport.class);
	Gson gson = new Gson();
