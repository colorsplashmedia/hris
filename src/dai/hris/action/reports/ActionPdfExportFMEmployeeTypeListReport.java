 ...
 */
@WebServlet("/ActionPdfExportFMEmployeeTypeListReport")
public class ActionPdfExportFMEmployeeTypeListReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportFMEmployeeTypeListReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/EmployeeTypeReport.jasper");
		...
		try {
			...
			List<EmployeeType> dataList = new ArrayList<EmployeeType>();	
			...
			if(forExport.equals("Y")) {
				sysModel.setProcessDesc("EXPORT EMPLOYEE TYPE REPORT");
				sysModel.setProcessType("EXPORT");
			} else {
				sysModel.setProcessDesc("VIEW PDF EMPLOYEE TYPE REPORT");
				sysModel.setProcessType("VIEW PDF");
			}
			
			sysModel.setModuleName("EMPLOYEE TYPE REPORT");
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/EmployeeTypeReport.jasper");
				...
				String reportName = "employeeTypeListReport" + "_" + employeeLoggedIn.getSectionId() 
