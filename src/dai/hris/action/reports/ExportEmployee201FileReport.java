 ...
 */
@WebServlet("/ExportEmployee201FileReport")
public class ExportEmployee201FileReport extends HttpServlet {
     ...
     */
    public ExportEmployee201FileReport() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		URL sourceFileName = getClass().getResource("/dai/hris/reports/Emp201File.jasper");		
		...
		try {			
			...
			String reportName = "employee_201_report" + "_" + sdf.format(calendar.getTime()) + ".xls";
...
//	                  "C://reports//employee_201_report.xls");
