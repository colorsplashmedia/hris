 ...
 */
@WebServlet("/ActionPdfExportFMDepartmentListReport")
public class ActionPdfExportFMDepartmentListReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportFMDepartmentListReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/DepartmentReport.jasper");
		...
		try {
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/DepartmentReport.jasper");
				...
				String reportName = "departmentListReport" + "_" + employeeLoggedIn.getSectionId() 
				...
				if(forExport.equals("Y")) {
					sysModel.setProcessDesc("EXPORT DEPARTMENT REPORT");
					sysModel.setProcessType("EXPORT");
				} else {
					sysModel.setProcessDesc("VIEW PDF DEPARTMENT REPORT");
					sysModel.setProcessType("VIEW PDF");
				}
				
				sysModel.setModuleName("DEPARTMENT REPORT");
