 ...
 */
@WebServlet("/ActionPdfExportGeneralProfessionalFeeReport")
public class ActionPdfExportGeneralProfessionalFeeReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportGeneralProfessionalFeeReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String reportStreamPath = "dai/hris/reports/GProfessionalFeeReport.jasper";
		String exportName = "professionalFeeReport";
...
//		int empId = Integer.parseInt(request.getParameter("empId"));
		...
		try {
			...
			map.put("REPORT_NAME", "GENERAL PAYROLL - PROFESSIONAL FEE REPORT");
			...
			dataList = service.getProfessionalFeeListByDateRange(dateFrom, dateTo);
