 ...
 */
@WebServlet("/ViewEmployee201FileReport")
public class ViewEmployee201FileReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ViewEmployee201FileReport.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/Emp201File.jasper");
		...
		map.put("COMPANY_NAME", ReportConstant.COMPANY_NAME);
