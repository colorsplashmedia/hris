 ...
 */
@WebServlet("/ActionPdfExportServiceRecordReport")
public class ActionPdfExportServiceRecordReport extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/ServiceRecordReport.jasper");
		...
		try {
			...
			map.put("REPORT_NAME", "SERVICE RECORD");			
			...
			map.put("empName", modelEmp.getFirstname() + " " + modelEmp.getMiddlename() + " " + modelEmp.getLastname());
			map.put("birthDate", modelEmp.getDateOfBirth());
			map.put("birthPlace", modelEmp.getBirthPlace());
			...
			List<ServiceRecord> dataList = new ArrayList<ServiceRecord>();	
			
			dataList = service.getServiceRecordReport(modelEmp.getEmpId());	
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/ServiceRecordReport.jasper");
				...
				String reportName = "serviceRecordReport" + "_" + modelEmp.getSectionId() 
