...
/**
 * Servlet implementation class ActionPdfExportNightDiffReport
 */
@WebServlet("/ActionPdfExportNightDiffReport")
public class ActionPdfExportNightDiffReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportNightDiffReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String reportStreamPath = "dai/hris/reports/NightDifferentialReport.jasper";
		String exportName = "nightDifferentialReport";
		...
		try {
			...
			map.put("REPORT_NAME", "NIGHT DIFFERENTIAL REPORT");
			
			IReportService service = new ReportService();
			String forExport = request.getParameter("forExport");
			
			List<NightDifferential> dataList = new ArrayList<NightDifferential>();	
			
			dataList = service.getNightDifferentialReport(Integer.parseInt(payrollPeriodId));	
			...
			for(int x = 0; x < numberOfExtra; x++){
				NightDifferential model = new NightDifferential();
...
//				NightDifferential model = new NightDifferential();     		    		
//	    		
//				model.setEmpNightDiffId(0);	    	
//		    	model.setEmpId(0);
//		    	model.setDateRendered("");
//		    	model.setNoOfHours(0);
//		    	model.setHourlyRate(0);
//		    	model.setHolidayRate(0);
//		    	model.setNightDiffAmount(BigDecimal.ZERO);
//		    	model.setPayrollPeriodId(0);
//		    	model.setEmpName("");
//		    	model.setEmpNo("");
