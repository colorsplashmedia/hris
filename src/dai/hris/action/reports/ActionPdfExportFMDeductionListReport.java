 ...
 */
@WebServlet("/ActionPdfExportFMDeductionListReport")
public class ActionPdfExportFMDeductionListReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportFMDeductionListReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/DeductionReport.jasper");
		...
		try {
			...
			List<Deduction> dataList = new ArrayList<Deduction>();	
			...
			if(dataList.isEmpty()){
				...
				model.setDeductionName("");
//				model.setAmount(BigDecimal.ZERO);
//				model.setEmployeeType("");
//				model.setPayrollType("");
//				model.setIsForSecondHalf("");
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/DeductionReport.jasper");
				...
				String reportName = "deductionListReport" + "_" + employeeLoggedIn.getSectionId() 
				...
				if(forExport.equals("Y")) {
					sysModel.setProcessDesc("EXPORT DEDUCTION REPORT");
					sysModel.setProcessType("EXPORT");
				} else {
					sysModel.setProcessDesc("VIEW PDF DEDUCTION REPORT");
					sysModel.setProcessType("VIEW PDF");
				}
				
				sysModel.setModuleName("DEDUCTION REPORT");
