 ...
 */
@WebServlet("/ActionPdfExportYearEndBonusListReport")
public class ActionPdfExportYearEndBonusListReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportYearEndBonusListReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/YearEndBonusReport.jasper");
		...
		try {
			...
			dataList = service.getYearEndBonusCashGiftListByEmpId(empId, startPageIndex,numRecordsPerPage, sorting);
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/YearEndBonusReport.jasper");
				...
				String reportName = "yearEndBonusListReport" + "_" + employeeLoggedIn.getSectionId() 
