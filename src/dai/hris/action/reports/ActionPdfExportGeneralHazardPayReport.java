 ...
 */
@WebServlet("/ActionPdfExportGeneralHazardPayReport")
public class ActionPdfExportGeneralHazardPayReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportGeneralHazardPayReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String reportStreamPath = "dai/hris/reports/HazardPayReport.jasper";
		String exportName = "hazardPayListReport";
...
//		int empId = Integer.parseInt(request.getParameter("empId"));
		...
		try {
			...
			map.put("REPORT_NAME", "HAZARD PAY REPORT");
			...
			dataList = service.getHazardPayListByDateRange(month, year);
