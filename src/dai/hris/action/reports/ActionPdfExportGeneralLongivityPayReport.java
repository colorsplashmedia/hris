 ...
 */
@WebServlet("/ActionPdfExportGeneralLongivityPayReport")
public class ActionPdfExportGeneralLongivityPayReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportGeneralLongivityPayReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String reportStreamPath = "dai/hris/reports/LongevityPayReport.jasper";
		String exportName = "longevityPayListReport";
...
//		int empId = Integer.parseInt(request.getParameter("empId"));
		...
		try {
			...
			map.put("REPORT_NAME", "LONGIVITY PAY REPORT");
			...
			dataList = service.getLongevityPayListByDateRange(month, year);
