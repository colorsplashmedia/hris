 ...
 */
@WebServlet("/ActionPdfExportFMMemoListReport")
public class ActionPdfExportFMMemoListReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportFMMemoListReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/MemoReport.jasper");
...
//			}
			...
			List<EmployeeMemo> dataList = new ArrayList<EmployeeMemo>();	
...
//			}
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/MemoReport.jasper");
				...
				String reportName = "empMemoListReport" + "_" + employeeLoggedIn.getSectionId() 
