 ...
 */
@WebServlet("/ActionPdfExportFMIncomeBenefitsListReport")
public class ActionPdfExportFMIncomeBenefitsListReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportFMIncomeBenefitsListReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/IncomeBenefitsReport.jasper");
...
//				dataList.add(model);
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/IncomeBenefitsReport.jasper");
				...
				String reportName = "incomeBenefitsListReport" + "_" + employeeLoggedIn.getSectionId() 
				...
				if(forExport.equals("Y")) {
					sysModel.setProcessDesc("EXPORT INCOME BENEFITS REPORT");
					sysModel.setProcessType("EXPORT");
				} else {
					sysModel.setProcessDesc("VIEW PDF INCOME BENEFITS REPORT");
					sysModel.setProcessType("VIEW PDF");
				}
				
				sysModel.setModuleName("INCOME BENEFITS REPORT");
