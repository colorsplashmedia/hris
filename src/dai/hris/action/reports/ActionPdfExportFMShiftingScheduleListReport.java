 ...
 */
@WebServlet("/ActionPdfExportFMShiftingScheduleListReport")
public class ActionPdfExportFMShiftingScheduleListReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportFMShiftingScheduleListReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/ShiftingScheduleReport.jasper");
		...
		try {
			...
			List<ShiftingSchedule> dataList = new ArrayList<ShiftingSchedule>();	
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/ShiftingScheduleReport.jasper");
				...
				String reportName = "shiftingScheduleListReport" + "_" + employeeLoggedIn.getSectionId() 
				...
				if(forExport.equals("Y")) {
					sysModel.setProcessDesc("EXPORT SHIFTING SCHEDULE REPORT");
					sysModel.setProcessType("EXPORT");
				} else {
					sysModel.setProcessDesc("VIEW PDF SHIFTING SCHEDULE REPORT");
					sysModel.setProcessType("VIEW PDF");
				}
				
				sysModel.setModuleName("SHIFTING SCHEDULE REPORT");
