 ...
 */
@WebServlet("/ActionPdfExportGeneralCaseRateReport")
public class ActionPdfExportGeneralCaseRateReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportGeneralCaseRateReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String reportStreamPath = "dai/hris/reports/GCaseRateReport.jasper";
		String exportName = "caseRatePaymentListReport";
...
//		int empId = Integer.parseInt(request.getParameter("empId"));
		...
		try {
			...
			map.put("REPORT_NAME", "GENERAL PAYROLL - CASE RATE");
			...
			dataList = service.getCaseRateListByDateRange(month, year);
