 ...
 */
@WebServlet("/ActionPdfExportMedicareShareListReport")
public class ActionPdfExportMedicareShareListReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportMedicareShareListReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/MedicareShareReport.jasper");
		...
		try {
			...
			dataList = service.getMedicareShareAllowanceListByEmpId(empId, startPageIndex,numRecordsPerPage, sorting);
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/MedicareShareReport.jasper");
				...
				String reportName = "medicareShareAllowanceListReport" + "_" + employeeLoggedIn.getSectionId() 
