 ...
 */
@WebServlet("/ActionPdfExportOvertimeSummaryReport")
public class ActionPdfExportOvertimeSummaryReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportOvertimeSummaryReport.class);
	Gson gson = new Gson();
...
//		int empId = Integer.parseInt(request.getParameter("empId"));
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/OvertimeSummaryReport.jasper");
		...
		try {
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/OvertimeSummaryReport.jasper");
				...
				if(forExport.equals("Y")) {
					sysModel.setProcessDesc("EXPORT OVERTIME SUMMARY REPORT");
					sysModel.setProcessType("EXPORT");
				} else {
					sysModel.setProcessDesc("VIEW PDF OVERTIME SUMMARY REPORT");
					sysModel.setProcessType("VIEW PDF");
				}
				
				sysModel.setModuleName("OVERTIME SUMMARY REPORT");
