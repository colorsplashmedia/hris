 ...
 */
@WebServlet("/ActionPdfExportFMLoanTypeListReport")
public class ActionPdfExportFMLoanTypeListReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportFMLoanTypeListReport.class);
	Gson gson = new Gson();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/LoanTypeReport.jasper");
		...
		try {
			...
			List<LoanType> dataList = new ArrayList<LoanType>();	
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/LoanTypeReport.jasper");
				...
				String reportName = "loanTypeListReport" + "_" + employeeLoggedIn.getSectionId() 
				...
				if(forExport.equals("Y")) {
					sysModel.setProcessDesc("EXPORT LOAN TYPE REPORT");
					sysModel.setProcessType("EXPORT");
				} else {
					sysModel.setProcessDesc("VIEW PDF LOAN TYPE REPORT");
					sysModel.setProcessType("VIEW PDF");
				}
				
				sysModel.setModuleName("LOAN TYPE REPORT");
