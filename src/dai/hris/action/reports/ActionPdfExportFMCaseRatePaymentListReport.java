 ...
 */
@WebServlet("/ActionPdfExportFMCaseRatePaymentListReport")
public class ActionPdfExportFMCaseRatePaymentListReport extends HttpServlet {
	private static final long serialVersionUID = 5676921778006010751L;
	private static Logger logger = Logger.getLogger(ActionPdfExportFMCaseRatePaymentListReport.class);
	Gson gson = new Gson();
...
//			}
			...
			List<CaseRatePayment> dataList = new ArrayList<CaseRatePayment>();	
...
//			}
			...
			dataList = service.getCaseRatePaymentListByEmpId(empId, startPageIndex,numRecordsPerPage, sorting);
			...
			if(forExport.equals("Y")) {
				...
				URL sourceFileName = getClass().getResource("/dai/hris/reports/CaseRateReport.jasper");
				...
				String reportName = "CaseRatePaymentListReport" + "_" + employeeLoggedIn.getSectionId() 
