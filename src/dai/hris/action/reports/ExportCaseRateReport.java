 ...
 */
@WebServlet("/ExportCaseRateReport")
public class ExportCaseRateReport extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {			
			...
			String reportName = "case_rate_report" + "_" + sdf.format(calendar.getTime()) + ".xls";
...
//	                  "C://reports//case_rate_report.xls");
