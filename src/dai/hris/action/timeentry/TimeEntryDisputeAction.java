 ...
 *
 */
@WebServlet("/TimeEntryDisputeAction")
 public class TimeEntryDisputeAction extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	 private static final long serialVersionUID = -6185891323760506163L;	 
	 /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public TimeEntryDisputeAction() {
		super();
	}   	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        timeInHrs = timeEntryService.converTimeToMilitaryTime(timeInHrs);
        timeOutHrs = timeEntryService.converTimeToMilitaryTime(timeOutHrs);
		...
		try {
			...
			timeEntryService.disputeTimeEntry(resolution);
