 ...
 *
 */
@WebServlet("/GetDisbursementVoucherListAction")
public class GetDisbursementVoucherListAction extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List<DisbursementVoucher> list = service.getAllDisbursementVouchers();
