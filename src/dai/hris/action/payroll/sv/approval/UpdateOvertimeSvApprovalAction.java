...
//		HttpSession session = request.getSession(true);   				
		...
		String empOvertimeId = request.getParameter("empOvertimeId");
		IEmployeeOvertimeService service = new EmployeeOvertimeService();
        
		try {
			
			EmployeeOvertime param = new EmployeeOvertime();
			
			param.setApprovedBy(employeeLoggedIn.getEmpId());
			param.setEmpOvertimeId(Integer.parseInt(empOvertimeId));
