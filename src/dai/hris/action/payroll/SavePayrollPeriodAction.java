	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			/*if ("jobTitle".equalsIgnoreCase(updateOption)) {
				...
				if(pp.getIsContractual().equals("N")){
					pp.setDeductGovtFlag("Y");
				} else {
					pp.setDeductGovtFlag("N");
				}
				...
				sysModel.setModuleName("PAYROLL PERIOD");				
				sysModel.setProcessDesc("Payroll Period: " + pp.getPayPeriod()
						+ " | Pay Year: " + pp.getPayYear()
						+ " | Pay Month: " + pp.getPayMonth()
						+ " | Accounting Code: " + pp.getPayrollCode()
						);
