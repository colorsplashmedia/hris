...
@WebServlet("/SaveEmployeeScheduleBulkAction")
public class SaveEmployeeScheduleBulkAction extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(param.get("weekday") instanceof String){
	        	...
	        	empId = (String)param.get("weekday");
	        	weekDayList.add(empId);
	        } else {
			...
			while(empIterator.hasNext()){
				...
				empSched.setScheduleDate(scheduleDateFrom);
				empSched.setToDate(scheduleDateTo);
				empSched.setSuperVisorId(supervisorId);
				
				service.saveEmployeeScheduleBulk(empSched, weekDayMap);				
			}
