 ...
 *
 */
@WebServlet("/DeleteLeaveTypeAction")
public class DeleteLeaveTypeAction extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			if(service.checkIfRecordHasBeenUsed(id)){
				...
				sysModel.setProcessDesc("Delete Leave Type: " + service.getLeaveTypeByLeaveTypeId(id).getLeaveTypeName());
