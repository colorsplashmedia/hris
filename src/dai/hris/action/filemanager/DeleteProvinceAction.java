 ...
 *
 */
@WebServlet("/DeleteProvinceAction")
public class DeleteProvinceAction extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			if(service.checkIfRecordHasBeenUsed(id)){
				...
				sysModel.setProcessDesc("Delete Province: " + service.getProvinceById(id).getProvinceName());
