...
@WebServlet("/GetAllProvinceAction")
public class GetAllProvinceAction extends HttpServlet {
...
//        response.getWriter().print(json);
		...
		JsonElement element = gson.toJsonTree(list,new TypeToken<List<Province>>(){}.getType());
