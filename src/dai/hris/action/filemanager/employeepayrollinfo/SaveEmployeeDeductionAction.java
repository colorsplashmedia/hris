 ...
 */
@WebServlet("/SaveEmployeeDeductionAction")
public class SaveEmployeeDeductionAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
	IEmployeeIncomeDeductionService service = new EmployeeIncomeDeductionService();
	Gson gson = new Gson();


    public SaveEmployeeDeductionAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("doPost SaveEmployeeDeductionAction");
...
//		try {
//			int empDeductionId = service.addDeduction(employeeDeduction);
