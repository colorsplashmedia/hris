...
@WebServlet("/GetAllEmployeeTypeAction")
public class GetAllEmployeeTypeAction extends HttpServlet {
...
//        response.getWriter().print(json);
		...
		JsonElement element = gson.toJsonTree(list,new TypeToken<List<EmployeeType>>(){}.getType());
