...
@WebServlet("/GetAllCountryAction")
public class GetAllCountryAction extends HttpServlet {
...
//        response.getWriter().print(json);
		...
		JsonElement element = gson.toJsonTree(list,new TypeToken<List<Country>>(){}.getType());
