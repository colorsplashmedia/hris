...
function viewReport (){
	...
	url = "/hris/ActionPdfExportDTRReport?month="+month+"&year="+year+"&verifiedBy="+verifiedBy+"&forExport=N";
...
function exportReport (){
	...
	var oAjaxCall = $.ajax({
		...
		data: "month="+month+"&year="+year+"&verifiedBy="+verifiedBy+"&forExport=Y",
		cache : false,
		async : false,
...
<div>		
	<div id="content">
		...
		<div style="width: 730px; margin: 0 auto; border: 1px solid black; height: 230px; margin-bottom: 20px;">
			<div style="background-color: black; color: white; padding: 10px;">DAILY TIME RECORD REPORT</div>
			...
			<div class="dataEntryInputRequisition"><input type="text" id="verifiedBy" name="verifiedBy" style="width:470px;" value="${param.verifiedBy}" placeholder="Verified By" /></div>
			<div class="cb"></div>					
			<div class="cb">
