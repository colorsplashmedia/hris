...
<html>
<head>
<title>GSIS MONTHLY REMITTANCE REPORT</title>
...
function viewReport (){
	...
	if(officeCode == ""){
		alert("Office Code is a mandatory field.");
		return;
	}
	...
	url = "/hris/ActionPdfExportGSISRemittanceReport?month="+month+"&year="+year+"&forExport=N&signatory1="+signatory1+"&position1="+position1+"&officeCode="+officeCode;
...
function exportReport (){
	...
	var oAjaxCall = $.ajax({
		type : "POST",
		url : "/hris/ActionPdfExportGSISRemittanceReport",
		
		data: "month="+month+"&year="+year+"&forExport=Y&signatory1="+signatory1+"&position1="+position1+"&officeCode="+officeCode,
		cache : false,
		async : false,
...
<div>		
	<div id="content">
		...
		<div style="width: 730px; margin: 0 auto; border: 1px solid black; height: 270px; margin-bottom: 20px;">
			<div style="background-color: black; color: white; padding: 10px;">GSIS MONTHLY REMITTANCE REPORT</div>
			...
			<div class="dataEntryInputRequisition"><input type="text" id="signatory1" name="signatory1" style="width:165px;" value="${param.signatory1}" placeholder="Certified By" /></div>
			...
			<div class="dataEntryText" style="text-indent: 20px;">Office Code</div>			
			<div><input type="text" id="officeCode" name="officeCode"  value="${param.position1}" style="width:490px;" placeholder="Office Code" /></div>
			<div class="cb"></div>		
			<div class="cb">
