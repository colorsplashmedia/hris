...
function viewReport (){
	...
	url = "/hris/ActionPdfExportMonthlyAttendanceReport?month="+month+"&year="+year+"&forExport=N&signatory1="+signatory1+"&signatory2="+signatory2+"&signatory3="+signatory3+"&position1="+position1+"&position2="+position2+"&position3="+position3;
...
function exportReport (){
	...
	var oAjaxCall = $.ajax({
		type : "POST",
		url : "/hris/ActionPdfExportMonthlyAttendanceReport",
		
		data: "month="+month+"&year="+year+"&forExport=Y&signatory1="+signatory1+"&signatory2="+signatory2+"&signatory3="+signatory3+"&position1="+position1+"&position2="+position2+"&position3="+position3,
		cache : false,
		async : false,
...
<div>		
	<div id="content">
		...
		<div style="width: 730px; margin: 0 auto; border: 1px solid black; height: 300px; margin-bottom: 20px;">
			<div style="background-color: black; color: white; padding: 10px;">MONTHLY ATTENDANCE REPORT</div>
			
			<div class="dataEntryText" style="width:150px;text-indent: 20px;">Month</div>
				<div class="datepicker">
					<select name="month" id="month" style="width:150px; height:31px; background:#fff; border: 1px solid #52833b; margin-top: 5px;" >													
			...
			<div class="dataEntryText" style="text-indent: 20px;">Prepared By</div>
			<div class="dataEntryInputRequisition"><input type="text" id="signatory1" name="signatory1" style="width:165px;" value="${param.signatory1}" placeholder="Prepared By" /></div>
			...
			<div class="cb"></div>
			<div class="dataEntryText" style="text-indent: 20px;">Certified By</div>
			<div class="dataEntryInputRequisition"><input type="text" id="signatory2" name="signatory2" style="width:165px;" value="${param.signatory2}" placeholder="Certified By" /></div>
			<div class="dataEntryText">Position</div>			
			<div><input type="text" id="position2" name="position2"  value="${param.position2}" style="width:165px;" placeholder="Position" /></div>
			
			
			<div class="cb"></div>		
			<div class="dataEntryText" style="text-indent: 20px;">Verified By</div>
			<div class="dataEntryInputRequisition"><input type="text" id="signatory3" name="signatory3" style="width:165px;" value="${param.signatory3}" placeholder="Verified By" /></div>
			<div class="dataEntryText">Position</div>			
