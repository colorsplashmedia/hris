...
<html>
<head>
<title>PHIC MONTHLY REMITTANCE REPORT</title>
...
function viewReport (){
	...
	url = "/hris/ActionPdfExportPHICRemittanceReport?month="+month+"&year="+year+"&forExport=N&signatory1="+signatory1+"&position1="+position1;
...
function exportReport (){
	...
	var oAjaxCall = $.ajax({
		type : "POST",
		url : "/hris/ActionPdfExportPHICRemittanceReport",
...
<div>		
	<div id="content">
		...
		<div style="width: 730px; margin: 0 auto; border: 1px solid black; height: 240px; margin-bottom: 20px;">
			<div style="background-color: black; color: white; padding: 10px;">PHIC MONTHLY REMITTANCE REPORT</div>
