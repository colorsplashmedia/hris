...
<html>
<head>
<title>YEAR END BONUS AND CASH GIFT REPORT</title>
...
<div>		
	<div id="content">
		...
		<div style="width: 730px; margin: 0 auto; border: 1px solid black; height: 130px; margin-bottom: 20px;">
			<div style="background-color: black; color: white; padding: 10px;">YEAR END BONUS AND CASH GIFT REPORT</div>
			
			
			<div class="dataEntryText" style="width:60px;text-indent: 20px;">Year</div>			
			<div><input type="text" id="year" name="year"  value="${param.year}" style="width:435px;" placeholder="Year" /></div>
			<div class="cb"></div>
