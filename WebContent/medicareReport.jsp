...
<html>
<head>
<title>MEDICARE SHARE ALLOWANCE REPORT</title>
...
function viewReport (){
	...
	url = "/hris/ActionPdfExportGeneralMedicareShareAllowanceReport?dateFrom="+dateFrom+"&dateTo="+dateTo+"&forExport=N";
...
<div>		
	<div id="content">
		...
		<div style="width: 730px; margin: 0 auto; border: 1px solid black; height: 130px; margin-bottom: 20px;">
			<div style="background-color: black; color: white; padding: 10px;">MEDICARE SHARE ALLOWANCE REPORT</div>
