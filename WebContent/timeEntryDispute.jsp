...
<script>
	$(document).ready(function() {	
		...
		$('#timeInHrs').timepicker();
		$('#timeOutHrs').timepicker();
...
<body>
	...
	<div id="content">
		...
		<div style="height: 330px; width: 400px; margin: 0px auto; background-color: #E8EDFF;">
				...
				<div id="resolutionHeader">Dispute Missing Time In and Out - ${param.clockDate}</div>
				...
				<div style="margin: 0px 0px 0px 25px;">
					...
					<textarea rows="6" cols="45" name="resolutionRemarks"></textarea>
					 -->
					<textarea rows="6" cols="61" id="resolutionRemarks" name="resolutionRemarks" placeholder="Update Time Entry Reason" style="width: 95%; margin: 10px 0px 20px 0px;"></textarea>
					<br />
				</div>
