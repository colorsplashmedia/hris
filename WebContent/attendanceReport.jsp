...
function viewReport (){
	...
	var forIndividual = "${param.forIndividual}";
	...
	url = "/hris/ActionPdfExportAttendanceSummaryReport?dateFrom="+dateFrom+"&dateTo="+dateTo+"&forIndividual="+forIndividual+"&forExport=N";
...
function exportReport (){
	...
	var oAjaxCall = $.ajax({
		...
		data: "dateFrom="+dateFrom+"&dateTo="+dateTo+"&forIndividual="+forIndividual+"&forExport=N",
		cache : false,
		async : false,
...
<div>		
	<div id="content">
		...
		<div style="width: 730px; margin: 0 auto; border: 1px solid black; height: 130px; margin-bottom: 20px;">
			<div style="background-color: black; color: white; padding: 10px;">ATTENDANCE REPORT</div>
