...
function saveModuleAccess() {
	...
	var oAjaxCall = $.ajax({
		type : "POST",		
		url : "/hris/SaveApproversAction?adminId="+adminId+"&adminAssistantId="+adminAssistantId+"&hrAdminId="+hrAdminId+"&hrAdminAssistantId="+hrAdminAssistantId+"&hrAdminLiasonId="+hrAdminLiasonId+"&isAdminChecked="+isAdminChecked,
		cache : false,
		async : false,
		dataType : "json",
...
function fnSearchEmployee(oSearchText) {
	...
	$.ajax({
		  'url': "/hris/SelectEmployeeAction?searchByText=true&oSearchText="+oSearchText,		 
		  'success': function(data) {
			  ...
			  divs +="<th scope=\"col\" width=\"150px;\">Name</th>";
...
<div id="content">
	...
	<div id="dashBoardRightPannel2" style="margin-left: 50px; margin-top: 0px;">	
		<div id="fixedButtonPlaceHolder"><div id="FixedSubmitButton2" onclick="javascript:saveModuleAccess();">SAVE APPROVERS</div></div>	    
	    <div>
				  	...
				  	<input type="hidden" name="createdBy" id="createdBy" value="${employeeLoggedIn.empId}" />
				   	...
				   	<div>
			  			...
			  			<div class="moduleAccessDetailContanier" style="height: 90px;">
			  				<div class="dataEntryText" style="width: 140px;">ADMIN</div>
							...
							<div class="dataEntryText" style="width: 140px;">ADMIN ASSISTANT</div>
							<div class="dataEntryInput">
...
<div id="searchEmployeeDialog" title="Search Employee" class="ui-front">
	<div id="searchArea" style="display:none" style="z-index: 3000;">
		...
		<div>			
			<a href=""></a>
			<input id="searchBox" name="searchBox" style="width: 180px;" type="text" size="40" placeholder="Type keyword here" />
			<div id="searchButton2" style="padding:12px 10px 12px 10px; cursor: pointer;">SEARCH</div>			
		</div>		 
	</div>
	<div class="cb"></div>
	<div>
