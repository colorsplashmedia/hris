...
<html>
<head>
<title>PAYROLL PROOFLIST REPORT</title>
...
function viewReport (){
	...
	var signatory5 = document.getElementById("signatory5").value;
	...
	url = "/hris/ActionPdfExportPayrollProffListReport?month="+month+"&year="+year+"&forExport=N&signatory1="+signatory1+"&signatory2="+signatory2+"&signatory3="+signatory3+"&signatory4="+signatory4+"&signatory5="+signatory5+"&position1="+position1+"&position2="+position2+"&position3="+position3+"&position4="+position4+"&position5="+position5;
...
function exportReport (){
	...
	var oAjaxCall = $.ajax({
		type : "POST",
		url : "/hris/ActionPdfExportPayrollProffListReport",				
		
		data: "month="+month+"&year="+year+"&forExport=N&signatory1="+signatory1+"&signatory2="+signatory2+"&signatory3="+signatory3+"&signatory4="+signatory4+"&signatory5="+signatory5+"&position1="+position1+"&position2="+position2+"&position3="+position3+"&position4="+position4+"&position5="+position5,
		cache : false,
		async : false,
...
<div>		
	<div id="content">
		...
		<div style="width: 730px; margin: 0 auto; border: 1px solid black; height: 380px; margin-bottom: 20px;">
			<div style="background-color: black; color: white; padding: 10px;">PAYROLL PROOFLIST REPORT</div>
			...
			<div class="cb"></div>		
			<div class="dataEntryText" style="text-indent: 20px;">5th Signatory</div>
			<div class="dataEntryInputRequisition"><input type="text" id="signatory5" name="signatory5" style="width:165px;" value="${param.signatory5}" placeholder="5th Signatory" /></div>
			<div class="dataEntryText">Position</div>			
			<div><input type="text" id="position5" name="position5"  value="${param.position5}" style="width:165px;" placeholder="Position" /></div>
			<div class="cb"></div>				
			<div class="cb">
