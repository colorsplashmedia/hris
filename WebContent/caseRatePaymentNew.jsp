...
function submitTransaction(){
	...
	if(batch == ""){
		alert("Batch is a required field.");
		errorExist = "Y";
		return;
	}
	...
	if(errorExist == "Y"){
		...
		var oAjaxCall = $.ajax({
			type : "POST",			
			url : "/hris/SaveCaseRatePaymentNewAction?empId="+empId+"&year="+year+"&month="+month+"&batch="+batch+"&officialReceiptDate="+officialReceiptDate+"&grossAmount="+grossAmount+"&withHoldingTax="+withHoldingTax+"&finalTax="+finalTax+"&netAmountDue="+netAmountDue+"&remarks="+remarks,
			cache : false,
			async : false,
			dataType : "json",
			success : function(data) {
				
				alert('Case Rate Payment has been successfully saved to the selected employees.');
...
function cancelProcessing() {	
	if (confirm('Are you sure you want to cancel the transaction?')) {
		window.location = "caseRatePayment.jsp";		
	}	
}
...
<div>		
	<div id="content">
		...
		<div  id="dashBoardRightPannel2" width="100%">	
			...
			<div style="width: 730px; border: 1px solid black; height: 420px; margin: 0px 0px 0px 15px;">
				<div style="background-color: black; color: white; padding: 10px;">SAVE CASE RATE PAYMENT</div>
				<div class="dataEntryText" style="text-indent: 20px;">Gross Amount</div>
				<div class="dataEntryInputRequisition">
					<input type="text" id="grossAmount" name="grossAmount" size="150"  value="" style="width:520px;"  placeholder="Gross Amount" />
				</div>
				<div class="dataEntryText" style="text-indent: 20px;">Withholding Tax</div>
				<div class="dataEntryInputRequisition">
				...
				<div class="dataEntryInputRequisition">
					<input type="text" id="finalTax" name="finalTax" size="150"   value="" style="width:520px;"  placeholder="Final Tax" />
				</div>
				<div class="dataEntryText" style="text-indent: 20px;">Net Amount Due</div>
				<div class="dataEntryInputRequisition">
					<input type="text" id="netAmountDue" name="netAmountDue" size="150"  value="" style="width:520px;"  placeholder="Net Amount Due" />
				</div>
				<div class="cb"></div>				
				<div class="dataEntryText" style="text-indent: 20px;">Year</div>
				<div class="dataEntryInputRequisition">
					<input type="text" id="year" name="year" size="150"  value="" style="width:520px;"  placeholder="Year" />
				</div>
				<div class="cb"></div>
				<div class="dataEntryText" style="text-indent: 20px;">Month</div>
				<div class="dataEntryInputRequisition">
				...
				<div class="cb"></div>
				<div class="dataEntryText" style="text-indent: 20px;">OR Date</div>
				<div class="dataEntryInputRequisition">
					<input type="text" id="officialReceiptDate" name="officialReceiptDate" size="150" class="useDPicker" value="" style="width:520px;"  placeholder="OR Date" />
				</div>
				<div class="cb"></div>
				<div class="dataEntryText" style="text-indent: 20px;">Batch</div>
				<div class="dataEntryInputRequisition">
					<input type="text" id="batch" name="batch" size="150"  value="" style="width:520px;"  placeholder="Batch" />
				</div>
				<div class="cb"></div>
