...
function submitTransaction(){
	...
	if(errorExist == "Y"){
		...
		var oAjaxCall = $.ajax({
			type : "POST",			
			url : "/hris/AddBulkNotificationAction?empId="+empId+"&memoFiledDate="+memoFiledDate+"&ccRecipient="+ccRecipient+"&fromSender="+fromSender+"&subject="+subject+"&message="+message+"&remarks="+remarks,
			cache : false,
			async : false,
			dataType : "json",
			success : function(data) {
				
				alert('Notification has been successfully saved to the selected employees.');
	...
	<div id="content">
		...
		<div  id="dashBoardRightPannel2" width="100%">	
			...
			<div style="width: 730px; border: 1px solid black; height: 360px; margin: 0px 0px 0px 15px;">
				<div style="background-color: black; color: white; padding: 10px;">SEND EMPLOYEE NOTIFICATION</div>
				<div class="dataEntryText" style="text-indent: 10px;">Notification From</div>
				<div class="dataEntryInputRequisition">
					<input type="text" id="fromSender" name="fromSender" size="150"  value="" style="width:520px;"  placeholder="Notification From" />
				</div>
				<div class="dataEntryText" style="text-indent: 10px;">Copy Furnish</div>
				<div class="dataEntryInputRequisition">
					<input type="text" id="ccRecipient" name="ccRecipient" size="150"  value="" style="width:520px;"  placeholder="Copy Furnish" />
				</div>
				<div class="dataEntryText" style="text-indent: 10px;">Date Filled</div>
				<div class="dataEntryInputRequisition">
				...
				<div class="dataEntryText" style="text-indent: 10px;">Subject</div>
				<div class="dataEntryInputRequisition">
					<input type="text" id="subject" name="subject" size="150"  value="" style="width:520px;"  placeholder="Subject" />
				</div>
				<div class="cb"></div>
				<div class="dataEntryText" style="text-indent: 10px;">Message</div>
				<div class="dataEntryInputRequisition">
