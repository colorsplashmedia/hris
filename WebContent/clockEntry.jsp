									...
									<tr>
										...
										<td width="30px;">
											<c:if test="${timeEntryProb.shiftScheduleId != 2000 && timeEntryProb.shiftScheduleId != 2001}">
												<!-- <div id="resolveButton" style="color: red; cursor: pointer;" onClick="resolveTimeEntry(${timeEntryProb.timeEntryId},${timeEntryProb.empId},${timeEntryProb.shiftScheduleId});">Resolve</div> -->
												<a class="resolveButton2" style="text-decoration: none; color: white;" href="/hris/timeEntryDispute.jsp?empId=${timeEntryProb.empId}&shiftScheduleId=${timeEntryProb.shiftScheduleId}&timeEntryId=${timeEntryProb.timeEntryId}&clockDate=${param.clockDate}">Dispute</a>
											</c:if>
										</td>
									</tr>
								</c:forEach>
