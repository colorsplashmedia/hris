...
<div id="content">
	<div id="dashBoardLeftPannel">
		...
		<div style="float: left; margin-left: 15px; margin-top: 0px;">
			<select name="jobTitleId" id="jobTitleDropDownID" style="width:214px; height:30px; background:#fff; border: 1px solid #52833b; margin-top: 5px; color: black; font-size: 16px;" >			    													
	...
	<div id="dashBoardRightPannel">
			<div id="tabs-nohdr">
			  <ul>
			    <li><a href="#tabs-nohdr-1">Hazard Pay</a></li>			    
			  </ul>
			  <div id="tabs-nohdr-1">			    
			    <form method="POST" id="addHazardPayForm" name="addHazardPayForm" action="SaveHazardPayAction">
				    ...
				    <div class="cb"></div>
				    <div class="dataEntryText">Hazard Pay</div>
				    <div class="dataEntryInput"><input type="text" name="hazardPay"  value="${param.hazardPay}" placeholder="Hazard Pay" /></div>
				    ...
				    <div class="cb"></div>
				    <div class="dataEntryText">EAMC Deduction</div>
				    <div class="dataEntryInput"><input type="text" name="eamcDeduction"  value="${param.eamcDeduction}" placeholder="EAMC Deduction" /></div>
