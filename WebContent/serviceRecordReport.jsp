...
function viewReport (){
	...
	if(signatory1 == ""){
		alert("Name of Signatory is a mandatory field.");
		return;
	}
	...
	url = "/hris/ActionPdfExportServiceRecordReport?forExport=N&signatory1="+signatory1+"&position1="+position1+"&empId="+empId;
...
function exportReport (){
	...
	var oAjaxCall = $.ajax({
		type : "POST",
		url : "/hris/ActionPdfExportServiceRecordReport",				
		
		data: "forExport=Y&signatory1="+signatory1+"&position1="+position1+"&empId="+empId,
		cache : false,
		async : false,
...
<div>		
	<div id="content">
		...
		<div style="width: 730px; margin: 0 auto; border: 1px solid black; height: 160px; margin-bottom: 20px;">
			<div style="background-color: black; color: white; padding: 10px;">SERVICE RECORD REPORT</div>			
