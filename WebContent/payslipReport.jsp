...
function viewReport (){
	...
	var singlePayslip = "${param.singlePayslip}";
	...
	url = "/hris/ActionPdfExportPayslipReport?payrollPeriodId=" + payrollPeriodId + "&singlePayslip=" + singlePayslip + "&forExport=N";
...
function exportReport (){
	...
	var oAjaxCall = $.ajax({
		...
		data: "payrollPeriodId=" + payrollPeriodId + "&singlePayslip=" + singlePayslip + "&forExport=Y",
		cache : false,
		async : false,
...
<div>		
	<div id="content">
		...
		<div style="width: 730px; margin: 0 auto; border: 1px solid black; height: 130px; margin-bottom: 20px;">
			<div style="background-color: black; color: white; padding: 10px;">PAYSLIP REPORT</div>
