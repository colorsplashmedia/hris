...
<html>
<head>
<title>Edit Disbursement Voucher Entry</title>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
    	...
    	var oAjaxCall = $.ajax({
    		type : "POST",
    		url : "GetDisbursementVoucherAction?disbursementVoucherId=" + disbursementVoucherId,
    		cache : false,
    		async : false,
    		dataType : "json",
    		success : function(data) {
    			//alert(data);
    			//alert(data.Records.modeOfPayment);
    			$('#modeOfPayment').val(data.Records.modeOfPayment);
    			$('#othersDetail').val(data.Records.othersDetail);
    			$('#payee').val(data.Records.payee);
    			$('#disbursementDate').val(data.Records.disbursementDate);
    			$('#fundCluster').val(data.Records.fundCluster);
    			$('#dvNo').val(data.Records.dvNo);
    			$('#tin').val(data.Records.tin);
    			$('#ors').val(data.Records.ors);
    			...
    			$('#accountingTitle').val(data.Records.accountingTitle);
    			$('#uacsCode').val(data.Records.uacsCode);
    			$('#debit').val(data.Records.debit);
    			$('#credit').val(data.Records.credit);
    			...
    			$('#signatory3').val(data.Records.signatory3);
    			$('#position3').val(data.Records.position3);
    			$('#checkNo').val(data.Records.checkNo);
    			$('#checkDate').val(data.Records.checkDate);
    			$('#bankDetails').val(data.Records.bankDetails);
    			$('#orNo').val(data.Records.orNo);
    			$('#orDate').val(data.Records.orDate);
    			$('#jevNo').val(data.Records.jevNo);
    			$('#certifiedMethod').val(data.Records.certifiedMethod);
    			$('#printedName').val(data.Records.printedName);
...
<div style="width: 1230px; border: 1px solid black; height: 800px; margin: 0px 0px 0px 15px; padding: 0px 0px 0px 0px">
	<input type="hidden" id="disbursementVoucherId" name="disbursementVoucherId"  value="${param.disbursementVoucherId}" />
	<div style="background-color: black; color: white; padding: 10px;">EDIT DISBURSEMENT VOUCHER</div>
